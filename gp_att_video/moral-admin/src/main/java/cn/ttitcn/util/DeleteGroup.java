...
public class DeleteGroup {
    ...
    //提供给主函数调用的方法
    public static void doDeleteGroup(String requestUrl,String APPID,String apiSecret,String apiKey, String groupId){
        DeleteGroup deleteGroup = new DeleteGroup(requestUrl,APPID,apiSecret,apiKey);
        try {
            String resp = deleteGroup.doRequest(groupId);
     ...
     * @throws Exception 异常
     */
    public String doRequest(String groupId) throws Exception {
        ...
        String params = buildParam(groupId);
     ...
     * @return 参数字符串
     */
    private String  buildParam(String groupId) {
        String param = "{"+
                "    \"header\": {"+
                "        \"app_id\": \""+APPID+"\","+
                "        \"status\": 3"+
