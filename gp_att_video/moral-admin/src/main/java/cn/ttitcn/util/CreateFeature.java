...
public class CreateFeature {
    ...
    //提供给主函数调用的方法
    public static JSONObject doCreateFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH, String featherId){
        CreateFeature createFeature = new CreateFeature(requestUrl,APPID,apiSecret,apiKey,AUDIO_PATH);
        try {
            /*
            String resp = createFeature.doRequest(featherId);
            ...
            */
            JSONObject jsonObject = JSON.parseObject("{\"featureId\":\"abcefgh12\"}");
     ...
     * @throws Exception 异常
     */
    public String doRequest(String featherId) throws Exception {
        ...
        String params = buildParam(featherId);
     ...
     * @return 参数字符串
     */
    private String  buildParam(String featherId) throws IOException {
        String param = "{"+
                "    \"header\": {"+
                "        \"app_id\": \""+APPID+"\","+
                "        \"status\": 3"+
