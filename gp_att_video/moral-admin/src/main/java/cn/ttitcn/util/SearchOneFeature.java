...
public class SearchOneFeature {
    ...
    //构造函数,为成员变量赋值
    public SearchOneFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH){
    ...
    //提供给主函数调用的方法
    public static void doSearchOneFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH,String featureId) {
        SearchOneFeature searchOneFeature = new SearchOneFeature(requestUrl, APPID, apiSecret, apiKey, AUDIO_PATH);
        try {
            String resp = searchOneFeature.doRequest(featureId);
     ...
     * @throws Exception 异常
     */
    public String doRequest(String featureId) throws Exception {
        ...
        String params = buildParam(featureId);
     ...
     * @return 参数字符串
     */
    private String buildParam(String featureId) throws IOException {
        String param = "{" +
                "    \"header\": {" +
                "        \"app_id\": \"" + APPID + "\"," +
                "        \"status\": 3" +
