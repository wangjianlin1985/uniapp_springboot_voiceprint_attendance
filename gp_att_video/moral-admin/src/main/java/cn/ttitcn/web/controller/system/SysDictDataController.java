...
public class SysDictDataController extends BaseController {
	...
	public AjaxResult editSave(@Validated SysDictData dict) {
		...
		dictDataService.deleteRedis(SystemRedisKey.SYSTEM_DICTDATE_LABELPREFIX + dict.getDictType() + dict.getDictValue());
		
		// 保存修改的同时删除缓存
		return toAjax(dictDataService.updateRedis(dict,SystemRedisKey.SYSTEM_DICTDATA_TYPEPREFIX + dict.getDictType()));
	}
	...
	public AjaxResult remove(String ids) {
		...
		dictDataService.deleteRedis(SystemRedisKey.SYSTEM_DICTDATE_LABELPREFIX + data.getDictType() + data.getDictValue());
