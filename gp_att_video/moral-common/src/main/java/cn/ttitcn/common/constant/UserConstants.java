package cn.ttitcn.common.constant;
...
public class UserConstants {
	...
	/** 身份证是否唯一的返回结果 */
	public final static String USER_IDCARDNO_UNIQUE = "0";
	public final static String USER_IDCARDNO_NOT_UNIQUE = "1";

	/** 学工号 是否唯一的返回结果 */
	public final static String USER_CODE_UNIQUE = "0";
	public final static String USER_CODE_NOT_UNIQUE = "1";
