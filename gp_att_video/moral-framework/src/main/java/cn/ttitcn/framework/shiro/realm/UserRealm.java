package cn.ttitcn.framework.shiro.realm;
...
import cn.ttitcn.common.exception.user.RoleBlockedException;
...
import cn.ttitcn.framework.shiro.service.SysLoginService;
...
public class UserRealm extends AuthorizingRealm {
	...
	protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection arg0) {
		...
		if (user.isAdmin()) {
			...
			menus = menuService.selectPermsByUserId(user);
