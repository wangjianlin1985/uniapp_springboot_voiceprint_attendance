...
import cn.ttitcn.system.dao.SysRoleDeptDao;
import cn.ttitcn.system.dao.SysRoleMenuDao;
...
public class SysRoleServiceImpl extends BaseServiceImpl<SysRole> implements SysRoleService {
	...
	/**
	@Override
	public List<SysRole> listAll(SysRole role) {
		return SpringUtils.getAopProxy(this).listAll(role);
	}
	*/
